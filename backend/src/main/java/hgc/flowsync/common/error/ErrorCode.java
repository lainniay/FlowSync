...
public enum ErrorCode {
	...
	PROJECT_NOT_ARCHIVED(HttpStatus.CONFLICT, "The project is not archived."),
	...
	TASK_ASSIGNEE_CHANGED(HttpStatus.CONFLICT, "The task assignee changed. Refresh and retry."),
